...
##### [Introduction](#intro) | [Topics](#topics) | [Program](#program) | [Dates](#dates) | [Organizers](#org) | [Program Committee](#pc) | [Submission](#submission) | [Review](#review) | [Previous Editions](#previous)
...
* 9:05 - 9:50, Keynote
  ...
  * Abstract: Serverless computing is an autoscaling, pay-as-you-go paradigm that can efficiently support machine learning inference under bursty workloads. However, batching, which is essential for reducing latency and cost, is not natively supported by existing stateless serverless platforms. In this talk, we outline two methodologies that can result in efficient ML inference serving on serverless platforms: one that is based on a classic queuing model and one that is based on  a Transformer-based deep surrogate model that quickly learns the relationship between workload patterns, configurations, and performance outcomes, enabling fast optimization for unseen workloads. We show that the ML model ends up speeding up analytic optimization by over 55 times and generalizing well to previously unseen workloads.
  * Speaker's Bio: Evgenia Smirni is the Sidney P. Chockley Professor of Computer Science at William and Mary, Williamsburg, VA, USA. Her research interests include queuing networks, stochastic modeling, applied machine learning, dependability and reliability, and models for performance prediction of distributed systems and applications. She has served as the Program Co-Chair of QEST’05, ACM Sigmetrics/Performance’06, HotMetrics’10, ICPE’17, DSN’17, HPDC’19, and SRDS’19, and the cloud track Co-Chair of ICDCS’21. She served as the General Co-Chair of QEST’10, NSMC’10, ICPE’25, and as general chair of SIGMETRICS’23. She is an IEEE Fellow, an ACM Distinguished Scientist, and an elected member to the IFIP W.G.s 7.3 and 10.4.
...
### <a name="previous"></a>Previous Editions

* [WOCC’24: The Second International Workshop on Converged Computing co-located at ISC’24](https://kth-scalab.github.io/events/wocc24)
* [WOCC’23: The First International Workshop on Converged Computing co-located at ISC’23](https://kth-scalab.github.io/events/wocc23)
